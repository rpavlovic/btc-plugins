    	...
    	new AjaxUpload(button,{
    		...
    		onComplete: function(file, response){
    			...
    			if (response==="success"){
    				...
    				jQuery('<table style="width:100%"></table>').appendTo('#sf-custom-icons').html('<tr><td style="width:60%;text-align:center"><img class="sfcustomicon" src="<?php echo SFCUSTOMURL; ?>/' + file + '" alt="" /></td><td class="sflabel" style="text-align:center;width:30%">' + file + '</td><td class="sflabel" style="text-align:center;width:9%"><img src="<?php echo SFCOMMONIMAGES; ?>' + 'delete.png' + '" title="<?php echo esc_js(spa_text('Delete custom icon')); ?>" alt="" onclick="spjDelRowReload(\'' + site + '\', \'sfreloadci\');" /></td></tr>');
