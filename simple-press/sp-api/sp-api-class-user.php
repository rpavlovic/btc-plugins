...
Simple:Press
User Class
$LastChangedDate: 2015-06-10 19:36:17 -0700 (Wed, 10 Jun 2015) $
$Rev: 12993 $
*/
...
class spUser {
	...
	function __construct($ident=0, $current=false, $small=false) {
		global $spStatus, $spGlobals, $pluginData;
...
function sp_get_user($userid=0, $current=false, $small=false) {
	...
	if ($userid == 0 || !array_key_exists($userid, $USERS)) $USERS[$userid] = new spUser($userid, $current, $small);
