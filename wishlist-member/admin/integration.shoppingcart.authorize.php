...
?>
    ...
    <blockquote>
      ...
      <form method="post">
        <h2 class="wlm-integration-steps"><?php _e('Step 2. Set your Thank You URL', 'wishlist-member'); ?></h2>
      ...
      <h2 class="wlm-integration-steps"><?php _e('Step 3. Create a Simple Checkout Item for each membership level using the Item IDs specified below', 'wishlist-member'); ?></h2>
      <br>
      <table class="widefat">
        <thead>
          <tr>
...
?>
    ...
    <form method="post">
    <p><?php printf(__('You can choose to enable <a href="%1$s" target="_blank">Authorize.Net Sandbox</a> to test your Authorize.Net integration', 'wishlist-member'), 'https://sandbox.authorize.net/'); ?></p>
      <blockquote>
        <p><label>
