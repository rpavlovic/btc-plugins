...
if (wlm_arrval($_GET,'mode') == 'ar') {
	...
	echo '<h2>' . __('Integration', 'wishlist-member') . ' &raquo; ' . __('Webinar', 'wishlist-member') . ' &raquo; <span id="integration-name"></span></h2>';
	include($this->pluginDir . '/admin/integration.webinar.php');
} elseif (wlm_arrval($_GET,'mode') == 'other') {
	echo '<h2>' . __('Integration', 'wishlist-member') . ' &raquo; ' . __('Other', 'wishlist-member') . ' &raquo; <span id="integration-name"></span></h2>';
	include($this->pluginDir . '/admin/integration.other.php');
} elseif (wlm_arrval($_GET,'mode') == '') {
	echo '<h2> ' . __('Integration', 'wishlist-member') . ' &raquo; ' . __('Shopping Cart', 'wishlist-member') . ' &raquo; <span id="integration-name"></span></h2>';
