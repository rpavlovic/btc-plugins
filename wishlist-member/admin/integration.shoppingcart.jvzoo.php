...
if (wlm_arrval($_GET, 'cart') == $__index__) {
	if (!$__INTERFACE__) {
		...
		<blockquote>
			<form method="post">
				<h2 class="wlm-integration-steps"><?php _e('Step 1: JVZIPN Secret Key', 'wishlist-member'); ?></h2>
				<p><?php _e ('Login to your JVZoo account and set the code below as your JVZIPN Secret Key under "My Accounts"','wishlist-member'); ?></p>
			...
			<form method="post">
				<h2 class="wlm-integration-steps"><?php _e('Step 2: Thank You Page and JVZIPN URL', 'wishlist-member'); ?></h2>
				<p><?php _e('Use the URL below for your JVZoo products "Thank You Page" and "JVZIPN URL"','wishlist-member'); ?></p>
			...
			<h2 class="wlm-integration-steps"><?php _e('Step 3. Use the following Membership Level SKUs for your JVZoo products', 'wishlist-member'); ?></h2>
