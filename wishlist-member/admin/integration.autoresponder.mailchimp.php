 ...
 * Version: $Id: integration.autoresponder.mailchimp.php 2409 2014-10-23 19:08:55Z mike $
 */
...
if ($data['ARProvider'] == $__index__):
	if ($__INTERFACE__):
		...
		<form method="post">
			...
			<p><?php _e('Get your API Key from ', 'wishlist-member'); ?><a href="http://admin.mailchimp.com/account/api/" target="_blank">http://admin.mailchimp.com/account/api/</a></p>
			...
			<p>Map your membership levels to your email lists by selecting a list from the dropdowns provided under the "List Id" column.</p>
			<table class="widefat">
				<thead>
					<tr>
