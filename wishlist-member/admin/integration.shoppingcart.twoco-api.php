 ...
 * Version: $Id: integration.shoppingcart.twoco-api.php 2389 2014-10-22 15:59:18Z mike $
 */
...
if (wlm_arrval($_GET, 'cart') == $__index__) {
	if (!$__INTERFACE__) {
		...
		<form method="post" id="stripe_form">
			<h2 class="wlm-integration-steps"><?php _e('Step 1. Setup API Keys','wishlist-member'); ?></h2>
			...
			<h2 class="wlm-integration-steps"><?php _e('Step 2. Configure Billing Settings','wishlist-member'); ?></h2>
			<br/>
			...
			<h2 class="wlm-integration-steps"><?php echo __("Step 3. Customize Payment Form", "wishlist-member") ?></h2>
			<table class="form-table">
				<tr>
				...
				<tr>
					...
					<td><div id="logo-preview"><?php if (!empty($logo)): ?> <img src="<?php echo $logo ?>" style="width: 90px; height: 40px;"></img><?php endif; ?></div><input id="stripe-logo" type="text" name="twocheckoutapisettings[logo]" value="<?php echo $logo ?>"/> <a href="media-upload.php?type=image&amp;TB_iframe=true" class="thickbox logo-upload button-secondary">Change</a>
				</tr>
				<tr>
			...
			<h2 class="wlm-integration-steps"><?php echo __("Miscellaneous", "wishlist-member") ?></h2> 
			<table class="form-table">
				<tr>
		...
		?>
			...
			<p><em>Note: These settings are the same as those in the standard 2Checkout Integration. Changing them here will also change them there.</em></p>
			...
			<p><?php _e('Use the URL below for 2Checkout\'s Instant Notification URL','wishlist-member'); ?></p>
