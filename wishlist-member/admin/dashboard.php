			...
			<div id="wl_dashboard_right_now" class="postbox">
				...
				<div class="inside">
					...
					<?php else: ?>
						...
						<?php  else: ?>
							<p style="color:red;">
								<?php echo __('<strong>Please reactivate your license in order to upgrade to the latest version.</strong>', 'wishlist-member'); ?>
							</p>
						<?php  endif; ?>
					<?php endif; ?>
				</div>
					...
					<div class="postbox">
						...
						<div class="inside">
							<form method="post" onsubmit="return confirm('<?php _e('Are you sure that you want to deactivate the license of this plugin for this site?', 'wishlist-member'); ?>')">
								<p class="submit">
									<?php _e("If you're migrating your site to a new server, or just need to cancel your license for this site, click the button below to deactivate the license of this plugin for this site.", 'wishlist-member'); ?>
									<?php if ( ! $WPWLKey || ! $WPWLEmail ): ?>
										<br /><br />
										<span style="color:red;">
											<?php echo __('<strong>Important!:</strong> Your license info was not properly saved. Kindly reactivate your license using the button below.', 'wishlist-member'); ?>
										</span>
									<?php  endif; ?>
									<br /><br />
