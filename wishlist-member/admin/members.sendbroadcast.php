	...
	<form method="post" action="?<?php echo $form_action; ?>">
		...
		<p class="submit">
			<?php if (wlm_arrval($_POST,'preview')): ?>
				...
				<?php endif; ?>
				<input type="button" class="button-secondary" value="<?php _e('Go Back and Edit', 'wishlist-member'); ?>" onclick="this.form.action='?<?php echo $back_form_action; ?>';this.form.WishListMemberAction.value='';this.form.submit()" />
			<?php else : ?>
