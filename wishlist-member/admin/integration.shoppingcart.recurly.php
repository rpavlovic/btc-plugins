...
if (wlm_arrval($_GET, 'cart') == $__index__) {
	...
	if (!$__INTERFACE__) {
		...
		<form method="post" action="">
			<h2 class="wlm-integration-steps"><?php _e('Step 1. API Key', 'wishlist-member'); ?></h2><br/>
			...
			<h2 class="wlm-integration-steps"><?php _e('Step 2. Membership Levels and Recurly Plans', 'wishlist-member'); ?></h2><br/>
			...
			<br/>
			<h2 class="wlm-integration-steps"><?php _e('Step 3. Push Notification URL', 'wishlist-member'); ?></h2><br/>
