 ...
 * Version: $Id: integration.shoppingcart.paypal.php 2312 2014-09-03 04:28:04Z mike $
 */
...
if (wlm_arrval($_GET,'cart') == $__index__) {
	if (!$__INTERFACE__) {
		...
		<!-- PayPal -->
	<form method="post">
		<p id="pppersonalx">* <a href="javascript:void(0)" onclick="document.getElementById('pppersonal').style.display='block';document.getElementById('pppersonalx').style.display='none'"><?php _e('If you have a PayPal Personal Account, Click here', 'wishlist-member'); ?></a></p>
		...
		<blockquote>
			<h2 class="wlm-integration-steps"><?php _e('Step 1. Configure PayPal Settings.', 'wishlist-member'); ?></h2>
			...
			<h2 class="wlm-integration-steps"><?php _e('Step 2. Paste your PayPal "PDT Identity Token" below.', 'wishlist-member'); ?></h2>
			...
			<h2 class="wlm-integration-steps"><?php _e('Step 3. Create a "Buy Now" or "Subscribe" Button in Merchant Services Section of PayPal.<br />Create a button for each membership level using the Item/Subscription ID specified below.', 'wishlist-member'); ?></h2>
			...
			<table class="widefat">
				<thead>
					<tr>
						...
						<th scope="col">
							<?php _e('Item/Subscription ID', 'wishlist-member'); ?>
		...
		<?php endforeach; ?>
			...
			?>
				...
				<h2 class="wlm-integration-steps"><?php _e('Step 4. Set the "Thank You URL" of each product to the following URL:', 'wishlist-member'); ?></h2>
				...
				<h2 class="wlm-integration-steps"><?php _e('Step 5. Paste the code below in the "Add advanced variables" field:', 'wishlist-member'); ?></h2>
				<p><b>rm=2<br />bn=WishListProducts_SP<br />notify_url=<?php echo $ppthankyou_url ?><br />return=<?php echo $ppthankyou_url ?></b></p>
			...
			<h2 class="wlm-integration-steps"><?php _e('Step 6. Paste the button code', 'wishlist-member'); ?></h2>
			<p><?php _e('Paste the button code generated by PayPal to your sales Page.', 'wishlist-member'); ?></p>
			<h2 class="wlm-integration-steps"><?php _e('Step 7. Support for $0 Trial Subscriptions (Optional)', 'wishlist-member'); ?></h2>
