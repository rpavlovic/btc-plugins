...
if (wlm_arrval($_GET, 'cart') == $__index__) {
	if (!$__INTERFACE__) {
		...
		<blockquote>
			<form method="post">
				<h2 class="wlm-integration-steps"><?php _e('Step 1. Infusionsoft API Connection', 'wishlist-member'); ?></h2>
			...
			<h2 class="wlm-integration-steps"><?php _e('Step 2. Create a product for each membership level using the SKUs specified below', 'wishlist-member'); ?></h2>
			<form method="post">
		...
		<?php include_once($this->pluginDir . '/admin/integration.shoppingcart-payperpost-skus-if.php'); ?>
			<form method="post">
				<h2 class="wlm-integration-steps"><?php _e('Step 3. Create an Order Form for each product created and set the "Web Page URL" to the ff:', 'wishlist-member'); ?></h2>
		...
		<?php echo $this->Tooltip("integration-shoppingcart-infusionsoft-tooltips-thankyouurlsku"); ?>
			...
			<h2 class="wlm-integration-steps"><?php _e('Step 4. Setup Cron Job', 'wishlist-member'); ?> <?php echo $this->Tooltip("integration-shoppingcart-infusionsoft-tooltips-Setup-Cron-Job"); ?></h2>
