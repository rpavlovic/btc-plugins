 ...
 * Version: $Id: integration.autoresponder.icontact.php 2389 2014-10-22 15:59:18Z mike $
 */
...
//after user saves the autoresponder options, script will get AccountID & FolderID
		...
		<form method="post">
			...
			<h2 class="wlm-integration-steps"><?php _e('Step 1. Create your iContact Integration Password', 'wishlist-member'); ?></h2>
			<ol style="margin-left:3em">
					<li><?php _e('Visit ', 'wishlist-member'); ?> <a href="https://app.icontact.com/icp/core/externallogin" target="_blank">https://app.icontact.com/icp/core/externallogin</a></li>
					<li><?php _e('Enter your iContact username and password to log in to iContact.', 'wishlist-member'); ?></li>
					<li><?php _e('Enter <strong style="background:yellow;font-size:1.2em">60ZU6Al45lBtMmpi1S8tJqsvXdrNK18H</strong> on the Application ID field.', 'wishlist-member'); ?></li>
					<li><?php _e('Enter your desired APPLICATION PASSWORD (<span style="font-style:italic;">This will be used on the next step</span>).'); ?><br>
					<?php _e('<span style="font-style:italic;">Note: For security reasons, we recommend that this password be different than your iContact password.</span>', 'wishlist-member'); ?></li>
			...
			<?php if ($icAcctID == "" || $icFolderID == "") { ?>
				<p class="submit">
					...
					<input type="submit" class="button button-primary" value="<?php _e('Click here to Generate your Account &amp; Folder ID then Proceed to Step 3', 'wishlist-member'); ?>" />&nbsp;&nbsp;&nbsp;
				</p>
			<?php } else { ?>
				<br />
