 ...
 * Version: $Id: integration.autoresponder.generic.php 2306 2014-08-27 22:05:26Z mike $
 */
...
if ($data['ARProvider'] == $__index__):
	if ($__INTERFACE__):
		?>
		<form method="post">
			<h2 class="wlm-integration-steps">Step 1. Specify Subscribe and Unsubscribe Emails</h2>
			<p>The generic integration simply sends an email to the "Subscribe" and "Unsubscribe" emails you specify in the fields below.</p>
