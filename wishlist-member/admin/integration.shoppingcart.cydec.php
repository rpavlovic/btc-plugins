 ...
 * Version: $Id: integration.shoppingcart.cydec.php 2389 2014-10-22 15:59:18Z mike $
 */
...
if (wlm_arrval($_GET,'cart') == $__index__) {
	if (!$__INTERFACE__) {
		...
		<blockquote>
			<form method="post">
				<h2 class="wlm-integration-steps"><?php _e('Step 1. Set the "Post To URL" of your Cydec account<br />or the "Post To URL" of each product to the following URL:', 'wishlist-member'); ?></h2>
			...
			<form method="post">
				<h2 class="wlm-integration-steps"><?php _e('Step 2. Specify a Secret Word.', 'wishlist-member'); ?></h2>
			...
			<h2 class="wlm-integration-steps"><?php _e('Step 3. Create a product for each membership level using the SKUs specified below', 'wishlist-member'); ?></h2>
			<table class="widefat">
				<thead>
					<tr>
