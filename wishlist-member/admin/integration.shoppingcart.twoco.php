 ...
 * Version: $Id: integration.shoppingcart.twoco.php 2389 2014-10-22 15:59:18Z mike $
 */
...
if (wlm_arrval($_GET,'cart') == $__index__) {
	if (!$__INTERFACE__) {
		...
		<!-- 2Checkout -->
		<blockquote>
			<h2 class="wlm-integration-steps"><?php _e('Step 1. 2Checkout Account Information','wishlist-member'); ?></h2>
			<?php include('form.integration.shoppingcart.twoco.accountinfo.php'); ?>
			<h2 class="wlm-integration-steps"><?php _e('Step 2. Use the URL below for 2Checkout\'s Instant Notification URL','wishlist-member'); ?></h2>
