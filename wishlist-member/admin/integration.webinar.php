...
if($webinar_provider == 'gotomeeting') {
	...
	echo '<p style="color:red;font-weight:bold">Important: The regular GotoWebinar <small><sup>&reg;</sup></small> integration is now deprecated. It is strongly recommended that you use the GotoWebinar API <small><sup>&reg;</sup></small> Integration instead.</p>';
	echo '</form>';
	echo '</div>';
}
?>
