 ...
 * Version: $Id: integration.shoppingcart.1shoppingcart.php 2312 2014-09-03 04:28:04Z mike $
 */
...
if (wlm_arrval($_GET,'cart') == $__index__) {
	if (!$__INTERFACE__) {
		...
		<!-- 1ShoppingCart -->
		<blockquote>
			<h2 class="wlm-integration-steps"><?php _e('Step 1. Set the "Thank You URL" of your 1ShoppingCart account<br />or the "Thank You URL" of each product to the following URL:', 'wishlist-member'); ?></h2>
			<form method="post">
			...
			<h2 class="wlm-integration-steps"><?php _e('Step 2. Create a product for each Membership Level or Pay Per Post using their assigned SKUs listed below', 'wishlist-member'); ?></h2>
			<table class="widefat">
				<thead>
					<tr>
		...
		<?php include_once($this->pluginDir . '/admin/integration.shoppingcart-payperpost-skus.php'); ?>
			...
			<h2 class="wlm-integration-steps"><?php _e('Step 3. Setup 1ShoppingCart API Settings', 'wishlist-member'); ?></h2>
		...
		<?php _e('No', 'wishlist-member'); ?></label>
			...
			<p><?php _e("If you are unfamiliar or uncomfortable setting up a Cron Job, please contact your hosting provider and give them the information below.  Your hosting provider can then set this up for you.", "wishlist-member")?></p>
			<p><?php _e("Setting the Cron Job for Once a day is recommended.", "wishlist-member")?></p>
