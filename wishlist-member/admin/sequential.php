					...
					<td style="line-height:2em" class="wlm_sequential_upgrade_schedule">
						...
						<span id="sequpgrade_schedule_<?php echo $key; ?>">
							...
							<span class="sequpgrade_schedule sequpgrade_schedule_ondate" style="display:none">
								<input class="seq_upgrade_ondate" name="upgradeOnDate[<?php echo $key; ?>]" value="<?php echo $level['upgradeOnDate'] ? date( 'm/d/Y h:i a', $level['upgradeOnDate'] ) : ''; ?>" size="24" placeholder="mm/dd/yyyy hh:ss" />
							</span>
						</span>
					</td>
