 ...
 * Version: $Id: integration.shoppingcart.premiumwebcart.php 2389 2014-10-22 15:59:18Z mike $
 */
...
if (wlm_arrval($_GET,'cart') == $__index__) {
	if (!$__INTERFACE__) {
		...
		<!-- Premium Web Cart -->
		<blockquote>
			<h2 class="wlm-integration-steps">Premium Web Cart Account Information</h2>
			<form method="post">
				<table class="form-table">
					<tr valign="top">
						...
						<td>
							...
							<div><?php _e('This is the Merchant ID that you find in your Premium Web Cart account under<br>"Account Settings" &raquo; "Current Status".', 'wishlist-member'); ?></div>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row">
						...
						<td>
							...
							<div><?php _e('This is the API key that you find in your Premium Web Cart account under<br>"Cart Settings" &raquo; "Advanced Integration" &raquo; "API Integration".', 'wishlist-member'); ?></div>
						</td>
					<tr valign="top">
						<th scope="row">
				...
				<h2 class="wlm-integration-steps"><?php _e('Step 2. Use the URL below for Premium Web Cart\'s Post/Callback URL', 'wishlist-member'); ?></h2>
			...
			<h2 class="wlm-integration-steps"><?php _e('Step 3. Create a product for each Membership Level or Pay Per Post using their assigned SKUs listed below', 'wishlist-member'); ?></h2>
