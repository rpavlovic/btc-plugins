 ...
 * Version: $Id: integration.autoresponder.php 2389 2014-10-22 15:59:18Z mike $
 */
...
if($data['ARProvider'] == 'aweber') {
	...
	echo '<p style="color:red;font-weight:bold">Important: The regular AWeber integration is now deprecated. It is strongly recommended that you use the AWeber API Integration instead.</p>';
	echo '</form>';
	echo '</div>';
}
if($data['ARProvider'] == 'getresponse') {
	echo '<div class="error">';
	echo '<form method="post">';
	echo '<p style="color:red;font-weight:bold">Important: The regular GetResponse integration is now deprecated. It is strongly recommended that you use the GetResponse API Integration instead.</p>';
	echo '</form>';
	echo '</div>';
}
