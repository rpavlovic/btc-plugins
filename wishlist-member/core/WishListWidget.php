...
if (!class_exists('WishListWidget')) {
	class WishListWidget extends WP_Widget {
		...
		function form($instance) {
			...
			$title = ! empty( $instance['title'] ) ? $instance['title'] : __( '', 'wishlist-member' );
			$title2 = ! empty( $instance['title2'] ) ? $instance['title2'] : __( '', 'wishlist-member' );
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'wpm_widget_hiderss' ); ?>"><?php echo __('Hide RSS Link', 'wishlist-member'); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'wpm_widget_hideregister' ); ?>"><?php echo __('Hide Register Link', 'wishlist-member'); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'wpm_widget_nologinbox' ); ?>"><?php echo __('Only display if member is logged in', 'wishlist-member'); ?></label>
			</p>
				...
				<label for="<?php echo $this->get_field_id( 'widget_hidelevels' ); ?>"><?php echo __('Hide membership levels', 'wishlist-member'); ?></label>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id( 'wpm_widget_fieldwidth' ); ?>"><?php echo __('Width of Login Fields', 'wishlist-member'); ?></label> <br />
