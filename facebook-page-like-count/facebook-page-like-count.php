<?php
/*
 * Plugin Name: Facebook Page Like Count
 * Plugin URI: http://presshive.com
 * Author: <a href="http://presshive.com/">Presshive</a>
 * Version: 1.0
 * Description: Shows the Facebook page like count via shortcode or template tag. 
 * Tags: facebook, fb, like, like count, Facebook Page Like Count, facebook page likes
